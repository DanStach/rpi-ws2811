...
# Wait times give some global control of the effect speed
# These values relate to a RPI0W 
wait_time = .5
wait_animate = .1
cycleFactor = 1


# Here we define some common colors
cred = (255, 0, 0)
cblue = (0, 0, 255)
cgreen = (0, 255, 0)
cyellow = (255, 255, 0)
...
# Here we define some common group of colors. common xmas color groups, ect
